...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'birthday', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'articles', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'avatar', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'articleLikes', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
