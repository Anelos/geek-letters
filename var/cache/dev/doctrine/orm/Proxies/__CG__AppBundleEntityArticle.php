...
class Article extends \AppBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'published', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'userLikes', 'createdAt', 'updatedAt'];
        }
    ...
    public function addUserLike(\AppBundle\Entity\User $userLike)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUserLike', [$userLike]);

        return parent::addUserLike($userLike);
    }
    ...
    public function removeUserLike(\AppBundle\Entity\User $userLike)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUserLike', [$userLike]);

        return parent::removeUserLike($userLike);
    }
    ...
    public function getUserLikes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserLikes', []);

        return parent::getUserLikes();
    }
